...
var wasmBinaryFile = 'rewrite_file.wasm';
...
var real__process_bytes = asm["_process_bytes"];
asm["_process_bytes"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__process_bytes.apply(null, arguments);
};
...
var _process_bytes = Module["_process_bytes"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_process_bytes"].apply(null, arguments)
};
